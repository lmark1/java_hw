...
/**
 * This class implements WebWorker interface. It creates a HTML page with the
 * current time displayed and it gives a different message depending if the
 * parameter called name is provided or not.
 * 
